view: seasonality_nbhd {
  ...
  measure: municipal_requests_specific_dt_sum {
    type: sum
    sql:${municipal_requests_specific_dt_count} ;;
  }

  measure: municipal_requests_specific_dt_avg {
    type: average
    sql:${municipal_requests_specific_dt_count} ;;
  }

  set: detail {
    fields: [municipal_requests_specific_dt_neighborhood_group, municipal_requests_specific_dt_category, municipal_requests_specific_dt_created_date_year, municipal_requests_specific_dt_created_date_month, municipal_requests_specific_dt_count]
  }
}
